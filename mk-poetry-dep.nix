...
pythonPackages.callPackage
  (
    ...
    let
      ...
      preferWheelFinal = preferWheel && pname != "wheel";
      fileInfo =
        let
          ...
          entries = (if preferWheelFinal then binaryDist ++ sourceDist else sourceDist ++ binaryDist) ++ eggs;
          lockFileEntry = (
